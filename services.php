    ...
    <div class="content">
        <div class="abbrand">
            ...
            <div class="breadcrump">
                <p> <a href="">Home </a><i class="fas fa-angle-right"></i> Services <i class="fas fa-angle-right"></i></p>
            </div>
        </div>
        <div class="services">
            <div class="serviceone">
                ...
                <div class="servicetexts">
                    <h2>Mobile and Web application development.</h2>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus facere nam a labore.</p>
                    <button>more <i class="fas fa-angle-right"></i></button>
                </div>
            </div>
            <div class="serviceone">
                <img src="./assets/images/jumbo.jpg" alt="Image">
                <div class="servicetexts">
                    <h2>Networking and Data Security Services.</h2>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus facere nam a labore.</p>
                    <button>more <i class="fas fa-angle-right"></i></button>
                </div>
            </div>
            <div class="serviceone">
                <img src="./assets/images/jumbo.jpg" alt="Image">
                <div class="servicetexts">
                    <h2>Brand design and technical design.</h2>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus facere nam a labore.</p>
                    <button>more <i class="fas fa-angle-right"></i></button>
                </div>
            </div>
        ...
        <div class="whyus">
            <h1>why choose us?</h1>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Omnis itaque distinctio quod voluptates obcaecati odit suscipit provident corporis minus explicabo corrupti veritatis natus molestiae, ipsum numquam! Ab numquam quidem esse odit culpa! Eaque, commodi minus?</p>
        </div>
    </div>
    <footer class="footer">
        <div class="footertop">
