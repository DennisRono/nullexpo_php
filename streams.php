...
<?php include "./inc/header.php"; ?>
    ...
    <div class="content" id="content">
        <div class="streams">
            <div class="streamstop">
                <div class="watchcolumn">
                <div class="watch">
                    <div class="watchtext">
                        <div class="nullexpobrand">
                            <img src="./assets/images/favicon_io/favicon.ico" alt="nullexpo.com">
                            <!-- <h2>nullexpo.com</h2> -->
                        </div>
                        <!-- <video controls class="video" id="video" preload="metadata" poster="./assets/images/arsenal.jpg">
                            <source src="http://ferrarico.referrari.com/live/60091_.m3u8" type="video/mp4"></source>
                          </video> -->
                          <iframe width="100%" height="460" frameborder="0" allowfullscreen="" src="https://yastatic.net/yandex-video-player-iframe-api-bundles/1.0-5946/?stream_url=https://d15kqacz1cx8ur.cloudfront.net/out/v1/4a571effc8ce49b5a3ac265aad5b53ba/Lcop07.m3u8&autoplay=true" scrolling="no"></iframe>
                        <h2>Arsenal vs Villareal</h2>
                        <span>Europa League [semi-finals]</span>
                    </div>
                </div>
                <div class="belowwatch">
                    <div class="nextad">
                        <img src="./assets/images/programming.jpg" alt="ad">
                        <div class="nextadtexts">
                            <h2>Roma vs Manchester United</h2>
                            <span>Europa League [semi-finals]</span>
                        </div>
                    </div>
                    ...
                    <div class="nextad">
                        ...
                        <div class="nextadtexts">
                            <h2>Hertha Bsc vs Freiburg</h2>
                            <span>Bundesliga</span>
                        </div>
                    </div>

                    <div class="nextad">
                        <img src="./assets/images/gazelle.jpg" alt="ad">
                        <div class="nextadtexts">
                            <h2>Chelsea vs Real Madrid</h2>
                            <span>Champions League [semi-finals]</span>
                        </div>
                    </div>
                </div>
                </div>
                <div class="next">
                    <div class="nextad">
                        <img src="./assets/images/arsenal.jpg" alt="ad">
                        <div class="nextadtexts">
                            <h2>Roma vs Manchester United</h2>
                            <span>Europa League [semi-finals]</span>
                        </div>
                    ...
                    <div class="nextad">
                        <img src="./assets/images/jumbo.jpg" alt="ad">
                        <div class="nextadtexts">
                            <h2>Hertha Bsc vs Freiburg</h2>
                            <span>Bundesliga</span>
                        </div>
            ...
            <div class="streamarticles">
                <div class="streamfeed">
                    <img src="./assets/images/programming.jpg" alt="Image">
                    <div class="streamfeedtexts">
                        <span class="streamfeedtags">programming</span>
                        <h2 class="streamfeedtitle">Lorem ipsum dolor sit amet.</h2>
                ...
                <div class="streamfeed">
                    <img src="./assets/images/woman.jpg" alt="Image">
                    <div class="streamfeedtexts">
                        <span class="streamfeedtags">programming</span>
                        <h2 class="streamfeedtitle">Lorem ipsum dolor sit amet.</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi voluptatibus rem libero sequi repellat, iusto hic, placeat quos cum id laboriosam culpa, illum explicabo quisquam eligendi? In quae porro vel facere. Iste natus ducimus modi.</p>
                ...
                <div class="streamfeed">
                    <img src="./assets/images/gazelle.jpg" alt="Image">
                    <div class="streamfeedtexts">
                        <span class="streamfeedtags">programming</span>
                        <h2 class="streamfeedtitle">Lorem ipsum dolor sit amet.</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi voluptatibus rem libero sequi repellat, iusto hic, placeat quos cum id laboriosam culpa, illum explicabo quisquam eligendi? In quae porro vel facere. Iste natus ducimus modi.</p>
                ...
                <div class="streamfeed">
                    <img src="./assets/images/yellow.jpg" alt="Image">
                    <div class="streamfeedtexts">
                        <span class="streamfeedtags">programming</span>
                        <h2 class="streamfeedtitle">Lorem ipsum dolor sit amet.</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi voluptatibus rem libero sequi repellat, iusto hic, placeat quos cum id laboriosam culpa, illum explicabo quisquam eligendi? In quae porro vel facere. Iste natus ducimus modi.</p>
